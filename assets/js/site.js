...
(function () {
  ...
  // Hover vào video để tự phát, rời chuột ra thì tạm dừng — chỉ trên desktop/web.
  function setupHoverAutoplay() {
    if (!window.matchMedia('(hover: hover) and (pointer: fine)').matches) return;
    document.querySelectorAll('video').forEach(function (video) {
      var wrapper = video.closest('.video-wrapper, .mobile-video-frame, .wide-video-frame') || video.parentElement;
